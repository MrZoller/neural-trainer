  ...
  return (
    <div className="bg-slate-900 rounded-xl p-5 border border-slate-800">
      ...
      <p className="text-sm text-slate-400 mb-4">
        Track 1: a multilayer perceptron learning handwritten digits — the network neural-viz taught
        you, at real scale. 109k parameters, 60k images, on whatever device this backend has.
      </p>
